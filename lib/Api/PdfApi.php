...
class PdfApi
{
    ...
    /**
     * Operation apiWebentityPdfEncryptedCompanyIdOrderIdGet
     *
     * Generate pdf file for encryptedCompanyId order.
     *
     * @param  string $encrypted_company_id The encrypted company identifier. (required)
     * @param  \Swagger\Client\Model\OrderId $order_id The order identifier. (required)
     * @param  int $webentity webentity (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\OrderPdfViewModel[]
     */
    public function apiWebentityPdfEncryptedCompanyIdOrderIdGet($encrypted_company_id, $order_id, $webentity)
    {
        list($response) = $this->apiWebentityPdfEncryptedCompanyIdOrderIdGetWithHttpInfo($encrypted_company_id, $order_id, $webentity);
        return $response;
    }

    /**
     * Operation apiWebentityPdfEncryptedCompanyIdOrderIdGetWithHttpInfo
     *
     * Generate pdf file for encryptedCompanyId order.
     *
     * @param  string $encrypted_company_id The encrypted company identifier. (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\OrderPdfViewModel[], HTTP status code, HTTP response headers (array of strings)
     */
    public function apiWebentityPdfEncryptedCompanyIdOrderIdGetWithHttpInfo($encrypted_company_id, $order_id, $webentity)
    {
        $returnType = '\Swagger\Client\Model\OrderPdfViewModel[]';
        $request = $this->apiWebentityPdfEncryptedCompanyIdOrderIdGetRequest($encrypted_company_id, $order_id, $webentity);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\OrderPdfViewModel[]',
    ...
    /**
     * Operation apiWebentityPdfEncryptedCompanyIdOrderIdGetAsync
     *
     * Generate pdf file for encryptedCompanyId order.
     *
     * @param  string $encrypted_company_id The encrypted company identifier. (required)
     ...
     */
    public function apiWebentityPdfEncryptedCompanyIdOrderIdGetAsync($encrypted_company_id, $order_id, $webentity)
    {
        return $this->apiWebentityPdfEncryptedCompanyIdOrderIdGetAsyncWithHttpInfo($encrypted_company_id, $order_id, $webentity)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiWebentityPdfEncryptedCompanyIdOrderIdGetAsyncWithHttpInfo
     *
     * Generate pdf file for encryptedCompanyId order.
     *
     * @param  string $encrypted_company_id The encrypted company identifier. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityPdfEncryptedCompanyIdOrderIdGetAsyncWithHttpInfo($encrypted_company_id, $order_id, $webentity)
    {
        $returnType = '\Swagger\Client\Model\OrderPdfViewModel[]';
        $request = $this->apiWebentityPdfEncryptedCompanyIdOrderIdGetRequest($encrypted_company_id, $order_id, $webentity);
    ...
    /**
     * Create request for operation 'apiWebentityPdfEncryptedCompanyIdOrderIdGet'
     *
     * @param  string $encrypted_company_id The encrypted company identifier. (required)
     * @param  \Swagger\Client\Model\OrderId $order_id The order identifier. (required)
     * @param  int $webentity (required)
     ...
     */
    protected function apiWebentityPdfEncryptedCompanyIdOrderIdGetRequest($encrypted_company_id, $order_id, $webentity)
    {
        ...
        if ($encrypted_company_id === null || (is_array($encrypted_company_id) && count($encrypted_company_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $encrypted_company_id when calling apiWebentityPdfEncryptedCompanyIdOrderIdGet'
            );
        }
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_id when calling apiWebentityPdfEncryptedCompanyIdOrderIdGet'
            );
        }
        // verify the required parameter 'webentity' is set
        if ($webentity === null || (is_array($webentity) && count($webentity) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webentity when calling apiWebentityPdfEncryptedCompanyIdOrderIdGet'
            );
        }

        $resourcePath = '/api/{webentity}/pdf/{encryptedCompanyId}/{orderId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation apiWebentityPdfEncryptedCompanyIdOrderIdVisdocIdGet
     *
     * Stream pdf file.
     *
     * @param  string $encrypted_company_id The encrypted company identifier. (required)
     * @param  \Swagger\Client\Model\OrderId $order_id The order identifier. (required)
     * @param  int $visdoc_id The visdoc Id. (required)
     * @param  int $webentity webentity (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string
     */
    public function apiWebentityPdfEncryptedCompanyIdOrderIdVisdocIdGet($encrypted_company_id, $order_id, $visdoc_id, $webentity)
    {
        list($response) = $this->apiWebentityPdfEncryptedCompanyIdOrderIdVisdocIdGetWithHttpInfo($encrypted_company_id, $order_id, $visdoc_id, $webentity);
        return $response;
    }

    /**
     * Operation apiWebentityPdfEncryptedCompanyIdOrderIdVisdocIdGetWithHttpInfo
     *
     * Stream pdf file.
     *
     * @param  string $encrypted_company_id The encrypted company identifier. (required)
     ...
     */
    public function apiWebentityPdfEncryptedCompanyIdOrderIdVisdocIdGetWithHttpInfo($encrypted_company_id, $order_id, $visdoc_id, $webentity)
    {
        $returnType = 'string';
        $request = $this->apiWebentityPdfEncryptedCompanyIdOrderIdVisdocIdGetRequest($encrypted_company_id, $order_id, $visdoc_id, $webentity);
    ...
    /**
     * Operation apiWebentityPdfEncryptedCompanyIdOrderIdVisdocIdGetAsync
     *
     * Stream pdf file.
     *
     * @param  string $encrypted_company_id The encrypted company identifier. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityPdfEncryptedCompanyIdOrderIdVisdocIdGetAsync($encrypted_company_id, $order_id, $visdoc_id, $webentity)
    {
        return $this->apiWebentityPdfEncryptedCompanyIdOrderIdVisdocIdGetAsyncWithHttpInfo($encrypted_company_id, $order_id, $visdoc_id, $webentity)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiWebentityPdfEncryptedCompanyIdOrderIdVisdocIdGetAsyncWithHttpInfo
     *
     * Stream pdf file.
     *
     * @param  string $encrypted_company_id The encrypted company identifier. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityPdfEncryptedCompanyIdOrderIdVisdocIdGetAsyncWithHttpInfo($encrypted_company_id, $order_id, $visdoc_id, $webentity)
    {
        $returnType = 'string';
        $request = $this->apiWebentityPdfEncryptedCompanyIdOrderIdVisdocIdGetRequest($encrypted_company_id, $order_id, $visdoc_id, $webentity);
    ...
    /**
     * Create request for operation 'apiWebentityPdfEncryptedCompanyIdOrderIdVisdocIdGet'
     *
     * @param  string $encrypted_company_id The encrypted company identifier. (required)
     * @param  \Swagger\Client\Model\OrderId $order_id The order identifier. (required)
     * @param  int $visdoc_id The visdoc Id. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiWebentityPdfEncryptedCompanyIdOrderIdVisdocIdGetRequest($encrypted_company_id, $order_id, $visdoc_id, $webentity)
    {
        // verify the required parameter 'encrypted_company_id' is set
        if ($encrypted_company_id === null || (is_array($encrypted_company_id) && count($encrypted_company_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $encrypted_company_id when calling apiWebentityPdfEncryptedCompanyIdOrderIdVisdocIdGet'
            );
        }
        // verify the required parameter 'order_id' is set
        if ($order_id === null || (is_array($order_id) && count($order_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $order_id when calling apiWebentityPdfEncryptedCompanyIdOrderIdVisdocIdGet'
            );
        }
        // verify the required parameter 'visdoc_id' is set
        if ($visdoc_id === null || (is_array($visdoc_id) && count($visdoc_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $visdoc_id when calling apiWebentityPdfEncryptedCompanyIdOrderIdVisdocIdGet'
            );
        }
        // verify the required parameter 'webentity' is set
        if ($webentity === null || (is_array($webentity) && count($webentity) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webentity when calling apiWebentityPdfEncryptedCompanyIdOrderIdVisdocIdGet'
            );
        }

        $resourcePath = '/api/{webentity}/pdf/{encryptedCompanyId}/{orderId}/{visdocId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($visdoc_id !== null) {
            $resourcePath = str_replace(
                '{' . 'visdocId' . '}',
                ObjectSerializer::toPathValue($visdoc_id),
                $resourcePath
            );
        }
        // path params
