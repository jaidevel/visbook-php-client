...
class CompanyInformationApi
{
    ...
    /**
     * Operation apiWebentityCompanyinformationGet
     *
     ...
     * @return \Swagger\Client\Model\CompanyInformationViewModel
     */
    public function apiWebentityCompanyinformationGet($webentity)
    {
        list($response) = $this->apiWebentityCompanyinformationGetWithHttpInfo($webentity);
        return $response;
    }

    /**
     * Operation apiWebentityCompanyinformationGetWithHttpInfo
     *
     * Return information about the current company.
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\CompanyInformationViewModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiWebentityCompanyinformationGetWithHttpInfo($webentity)
    {
        $returnType = '\Swagger\Client\Model\CompanyInformationViewModel';
        $request = $this->apiWebentityCompanyinformationGetRequest($webentity);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\CompanyInformationViewModel',
    ...
    /**
     * Operation apiWebentityCompanyinformationGetAsync
     *
     * Return information about the current company.
     *
     * @param  int $webentity (required)
     ...
     */
    public function apiWebentityCompanyinformationGetAsync($webentity)
    {
        return $this->apiWebentityCompanyinformationGetAsyncWithHttpInfo($webentity)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiWebentityCompanyinformationGetAsyncWithHttpInfo
     *
     * Return information about the current company.
     *
     * @param  int $webentity (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityCompanyinformationGetAsyncWithHttpInfo($webentity)
    {
        $returnType = '\Swagger\Client\Model\CompanyInformationViewModel';
        $request = $this->apiWebentityCompanyinformationGetRequest($webentity);
    ...
    /**
     * Create request for operation 'apiWebentityCompanyinformationGet'
     *
     * @param  int $webentity (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function apiWebentityCompanyinformationGetRequest($webentity)
    {
        // verify the required parameter 'webentity' is set
        if ($webentity === null || (is_array($webentity) && count($webentity) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webentity when calling apiWebentityCompanyinformationGet'
            );
        }

        $resourcePath = '/api/{webentity}/companyinformation';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation apiWebentityCompanyinformationIdGet
     *
     * Return company information by encrypted company Id.
     *
     * @param  string $id The encrypted company identifier. (required)
     * @param  int $webentity webentity (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\CompanyInformationViewModel
     */
    public function apiWebentityCompanyinformationIdGet($id, $webentity)
    {
        list($response) = $this->apiWebentityCompanyinformationIdGetWithHttpInfo($id, $webentity);
        return $response;
    }

    /**
     * Operation apiWebentityCompanyinformationIdGetWithHttpInfo
     *
     * Return company information by encrypted company Id.
     *
     * @param  string $id The encrypted company identifier. (required)
     ...
     * @return array of \Swagger\Client\Model\CompanyInformationViewModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiWebentityCompanyinformationIdGetWithHttpInfo($id, $webentity)
    {
        $returnType = '\Swagger\Client\Model\CompanyInformationViewModel';
        $request = $this->apiWebentityCompanyinformationIdGetRequest($id, $webentity);
    ...
    /**
     * Operation apiWebentityCompanyinformationIdGetAsync
     *
     * Return company information by encrypted company Id.
     *
     * @param  string $id The encrypted company identifier. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityCompanyinformationIdGetAsync($id, $webentity)
    {
        return $this->apiWebentityCompanyinformationIdGetAsyncWithHttpInfo($id, $webentity)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiWebentityCompanyinformationIdGetAsyncWithHttpInfo
     *
     * Return company information by encrypted company Id.
     *
     * @param  string $id The encrypted company identifier. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityCompanyinformationIdGetAsyncWithHttpInfo($id, $webentity)
    {
        $returnType = '\Swagger\Client\Model\CompanyInformationViewModel';
        $request = $this->apiWebentityCompanyinformationIdGetRequest($id, $webentity);
    ...
    /**
     * Create request for operation 'apiWebentityCompanyinformationIdGet'
     *
     * @param  string $id The encrypted company identifier. (required)
     * @param  int $webentity (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiWebentityCompanyinformationIdGetRequest($id, $webentity)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling apiWebentityCompanyinformationIdGet'
            );
        }
        // verify the required parameter 'webentity' is set
        if ($webentity === null || (is_array($webentity) && count($webentity) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webentity when calling apiWebentityCompanyinformationIdGet'
            );
        }

        $resourcePath = '/api/{webentity}/companyinformation/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
