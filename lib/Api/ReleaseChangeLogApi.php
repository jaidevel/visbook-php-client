...
/**
 * ReleaseChangeLogApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class ReleaseChangeLogApi
{
    ...
    /**
     * Operation apiWebentityReleasechangelogGet
     *
     ...
     * @return \Swagger\Client\Model\ReleaseChangeLogViewModel
     */
    public function apiWebentityReleasechangelogGet($webentity)
    {
        list($response) = $this->apiWebentityReleasechangelogGetWithHttpInfo($webentity);
        return $response;
    }

    /**
     * Operation apiWebentityReleasechangelogGetWithHttpInfo
     *
     * Get information about changes for all api version.
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\ReleaseChangeLogViewModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiWebentityReleasechangelogGetWithHttpInfo($webentity)
    {
        $returnType = '\Swagger\Client\Model\ReleaseChangeLogViewModel';
        $request = $this->apiWebentityReleasechangelogGetRequest($webentity);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\ReleaseChangeLogViewModel',
    ...
    /**
     * Operation apiWebentityReleasechangelogGetAsync
     *
     * Get information about changes for all api version.
     *
     * @param  int $webentity (required)
     ...
     */
    public function apiWebentityReleasechangelogGetAsync($webentity)
    {
        return $this->apiWebentityReleasechangelogGetAsyncWithHttpInfo($webentity)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiWebentityReleasechangelogGetAsyncWithHttpInfo
     *
     * Get information about changes for all api version.
     *
     * @param  int $webentity (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityReleasechangelogGetAsyncWithHttpInfo($webentity)
    {
        $returnType = '\Swagger\Client\Model\ReleaseChangeLogViewModel';
        $request = $this->apiWebentityReleasechangelogGetRequest($webentity);
    ...
    /**
     * Create request for operation 'apiWebentityReleasechangelogGet'
     *
     * @param  int $webentity (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function apiWebentityReleasechangelogGetRequest($webentity)
    {
        // verify the required parameter 'webentity' is set
        if ($webentity === null || (is_array($webentity) && count($webentity) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webentity when calling apiWebentityReleasechangelogGet'
            );
        }

        $resourcePath = '/api/{webentity}/releasechangelog';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
