...
class OrdersApi
{
    ...
    /**
     * Operation apiWebentityOrdersGet
     *
     ...
     * @return \Swagger\Client\Model\OrderExtendedViewModel[]
     */
    public function apiWebentityOrdersGet($webentity)
    {
        list($response) = $this->apiWebentityOrdersGetWithHttpInfo($webentity);
        return $response;
    }

    /**
     * Operation apiWebentityOrdersGetWithHttpInfo
     *
     * List the logged in guest's orders for current company.
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\OrderExtendedViewModel[], HTTP status code, HTTP response headers (array of strings)
     */
    public function apiWebentityOrdersGetWithHttpInfo($webentity)
    {
        $returnType = '\Swagger\Client\Model\OrderExtendedViewModel[]';
        $request = $this->apiWebentityOrdersGetRequest($webentity);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\OrderExtendedViewModel[]',
    ...
    /**
     * Operation apiWebentityOrdersGetAsync
     *
     * List the logged in guest's orders for current company.
     *
     * @param  int $webentity (required)
     ...
     */
    public function apiWebentityOrdersGetAsync($webentity)
    {
        return $this->apiWebentityOrdersGetAsyncWithHttpInfo($webentity)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiWebentityOrdersGetAsyncWithHttpInfo
     *
     * List the logged in guest's orders for current company.
     *
     * @param  int $webentity (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityOrdersGetAsyncWithHttpInfo($webentity)
    {
        $returnType = '\Swagger\Client\Model\OrderExtendedViewModel[]';
        $request = $this->apiWebentityOrdersGetRequest($webentity);
    ...
    /**
     * Create request for operation 'apiWebentityOrdersGet'
     *
     * @param  int $webentity (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function apiWebentityOrdersGetRequest($webentity)
    {
        // verify the required parameter 'webentity' is set
        if ($webentity === null || (is_array($webentity) && count($webentity) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webentity when calling apiWebentityOrdersGet'
            );
        }

        $resourcePath = '/api/{webentity}/orders';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation apiWebentityOrdersIdGet
     *
     * Returns specific order data by identified id.              If encryptedCompanyId empty, current companyId will be used.
     *
     * @param  int $id The order identifier. (required)
     * @param  int $webentity webentity (required)
     * @param  string $encrypted_company_id The encrypted company Id. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\OrderExtendedViewModel
     */
    public function apiWebentityOrdersIdGet($id, $webentity, $encrypted_company_id = null)
    {
        list($response) = $this->apiWebentityOrdersIdGetWithHttpInfo($id, $webentity, $encrypted_company_id);
        return $response;
    }

    /**
     * Operation apiWebentityOrdersIdGetWithHttpInfo
     *
     * Returns specific order data by identified id.              If encryptedCompanyId empty, current companyId will be used.
     *
     * @param  int $id The order identifier. (required)
     ...
     * @return array of \Swagger\Client\Model\OrderExtendedViewModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiWebentityOrdersIdGetWithHttpInfo($id, $webentity, $encrypted_company_id = null)
    {
        $returnType = '\Swagger\Client\Model\OrderExtendedViewModel';
        $request = $this->apiWebentityOrdersIdGetRequest($id, $webentity, $encrypted_company_id);
    ...
    /**
     * Operation apiWebentityOrdersIdGetAsync
     *
     * Returns specific order data by identified id.              If encryptedCompanyId empty, current companyId will be used.
     *
     * @param  int $id The order identifier. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityOrdersIdGetAsync($id, $webentity, $encrypted_company_id = null)
    {
        return $this->apiWebentityOrdersIdGetAsyncWithHttpInfo($id, $webentity, $encrypted_company_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiWebentityOrdersIdGetAsyncWithHttpInfo
     *
     * Returns specific order data by identified id.              If encryptedCompanyId empty, current companyId will be used.
     *
     * @param  int $id The order identifier. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityOrdersIdGetAsyncWithHttpInfo($id, $webentity, $encrypted_company_id = null)
    {
        $returnType = '\Swagger\Client\Model\OrderExtendedViewModel';
        $request = $this->apiWebentityOrdersIdGetRequest($id, $webentity, $encrypted_company_id);
    ...
    /**
     * Create request for operation 'apiWebentityOrdersIdGet'
     *
     * @param  int $id The order identifier. (required)
     * @param  int $webentity (required)
     * @param  string $encrypted_company_id The encrypted company Id. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiWebentityOrdersIdGetRequest($id, $webentity, $encrypted_company_id = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling apiWebentityOrdersIdGet'
            );
        }
        // verify the required parameter 'webentity' is set
        if ($webentity === null || (is_array($webentity) && count($webentity) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webentity when calling apiWebentityOrdersIdGet'
            );
        }

        $resourcePath = '/api/{webentity}/orders/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($encrypted_company_id !== null) {
            $queryParams['encryptedCompanyId'] = ObjectSerializer::toQueryValue($encrypted_company_id, null);
        }
