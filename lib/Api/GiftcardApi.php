...
class GiftcardApi
{
    ...
    /**
     * Operation apiWebentityGiftcardBalanceIdGet
     *
     * Get giftcard info by Id.
     *
     * @param  string $id giftcard id. (required)
     * @param  int $webentity webentity (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\GiftcardViewModel
     */
    public function apiWebentityGiftcardBalanceIdGet($id, $webentity)
    {
        list($response) = $this->apiWebentityGiftcardBalanceIdGetWithHttpInfo($id, $webentity);
        return $response;
    }

    /**
     * Operation apiWebentityGiftcardBalanceIdGetWithHttpInfo
     *
     * Get giftcard info by Id.
     *
     * @param  string $id giftcard id. (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\GiftcardViewModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiWebentityGiftcardBalanceIdGetWithHttpInfo($id, $webentity)
    {
        $returnType = '\Swagger\Client\Model\GiftcardViewModel';
        $request = $this->apiWebentityGiftcardBalanceIdGetRequest($id, $webentity);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\GiftcardViewModel',
    ...
    /**
     * Operation apiWebentityGiftcardBalanceIdGetAsync
     *
     * Get giftcard info by Id.
     *
     * @param  string $id giftcard id. (required)
     ...
     */
    public function apiWebentityGiftcardBalanceIdGetAsync($id, $webentity)
    {
        return $this->apiWebentityGiftcardBalanceIdGetAsyncWithHttpInfo($id, $webentity)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiWebentityGiftcardBalanceIdGetAsyncWithHttpInfo
     *
     * Get giftcard info by Id.
     *
     * @param  string $id giftcard id. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityGiftcardBalanceIdGetAsyncWithHttpInfo($id, $webentity)
    {
        $returnType = '\Swagger\Client\Model\GiftcardViewModel';
        $request = $this->apiWebentityGiftcardBalanceIdGetRequest($id, $webentity);
    ...
    /**
     * Create request for operation 'apiWebentityGiftcardBalanceIdGet'
     *
     * @param  string $id giftcard id. (required)
     * @param  int $webentity (required)
     *
     ...
     */
    protected function apiWebentityGiftcardBalanceIdGetRequest($id, $webentity)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling apiWebentityGiftcardBalanceIdGet'
            );
        }
        // verify the required parameter 'webentity' is set
        if ($webentity === null || (is_array($webentity) && count($webentity) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webentity when calling apiWebentityGiftcardBalanceIdGet'
            );
        }

        $resourcePath = '/api/{webentity}/giftcard/balance/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
