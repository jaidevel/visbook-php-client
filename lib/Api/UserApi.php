...
class UserApi
{
    ...
    /**
     * Operation apiWebentityUserDelete
     *
     ...
     * @return \Swagger\Client\Model\AnonymizationViewModel
     */
    public function apiWebentityUserDelete($webentity)
    {
        list($response) = $this->apiWebentityUserDeleteWithHttpInfo($webentity);
        return $response;
    }

    /**
     * Operation apiWebentityUserDeleteWithHttpInfo
     *
     * Anonymize user for current company and all related companies.
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\AnonymizationViewModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiWebentityUserDeleteWithHttpInfo($webentity)
    {
        $returnType = '\Swagger\Client\Model\AnonymizationViewModel';
        $request = $this->apiWebentityUserDeleteRequest($webentity);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\AnonymizationViewModel',
    ...
    /**
     * Operation apiWebentityUserDeleteAsync
     *
     * Anonymize user for current company and all related companies.
     *
     * @param  int $webentity (required)
     ...
     */
    public function apiWebentityUserDeleteAsync($webentity)
    {
        return $this->apiWebentityUserDeleteAsyncWithHttpInfo($webentity)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiWebentityUserDeleteAsyncWithHttpInfo
     *
     * Anonymize user for current company and all related companies.
     *
     * @param  int $webentity (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityUserDeleteAsyncWithHttpInfo($webentity)
    {
        $returnType = '\Swagger\Client\Model\AnonymizationViewModel';
        $request = $this->apiWebentityUserDeleteRequest($webentity);
    ...
    /**
     * Create request for operation 'apiWebentityUserDelete'
     *
     * @param  int $webentity (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function apiWebentityUserDeleteRequest($webentity)
    {
        // verify the required parameter 'webentity' is set
        if ($webentity === null || (is_array($webentity) && count($webentity) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webentity when calling apiWebentityUserDelete'
            );
        }

        $resourcePath = '/api/{webentity}/user';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\UserViewModel
     */
    public function apiWebentityUserGet($webentity)
    {
        list($response) = $this->apiWebentityUserGetWithHttpInfo($webentity);
        return $response;
    }

    /**
     * Operation apiWebentityUserGetWithHttpInfo
     *
     * Get user data with the most recent order.
     *
     * @param  int $webentity (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\UserViewModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiWebentityUserGetWithHttpInfo($webentity)
    {
        $returnType = '\Swagger\Client\Model\UserViewModel';
        $request = $this->apiWebentityUserGetRequest($webentity);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\UserViewModel',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                case 202:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\AcceptedResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation apiWebentityUserGetAsync
     *
     * Get user data with the most recent order.
     *
     * @param  int $webentity (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityUserGetAsync($webentity)
    {
        return $this->apiWebentityUserGetAsyncWithHttpInfo($webentity)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiWebentityUserGetAsyncWithHttpInfo
     *
     * Get user data with the most recent order.
     *
     * @param  int $webentity (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityUserGetAsyncWithHttpInfo($webentity)
    {
        $returnType = '\Swagger\Client\Model\UserViewModel';
        $request = $this->apiWebentityUserGetRequest($webentity);
    ...
    /**
     * Create request for operation 'apiWebentityUserGet'
     *
     * @param  int $webentity (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiWebentityUserGetRequest($webentity)
    {
        // verify the required parameter 'webentity' is set
        if ($webentity === null || (is_array($webentity) && count($webentity) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webentity when calling apiWebentityUserGet'
            );
        }
    ...
    /**
     * Operation apiWebentityUserPut
     *
     * Update user data for current company and all related companies. Can be partially updated.
     *
     * @param  int $webentity webentity (required)
     * @param  \Swagger\Client\Model\ChangeUserInfoViewModel $body User data with otp. (optional)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\AcceptedResult
     */
    public function apiWebentityUserPut($webentity, $body = null)
    {
        list($response) = $this->apiWebentityUserPutWithHttpInfo($webentity, $body);
        return $response;
    }

    /**
     * Operation apiWebentityUserPutWithHttpInfo
     *
     * Update user data for current company and all related companies. Can be partially updated.
     *
     * @param  int $webentity (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\AcceptedResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiWebentityUserPutWithHttpInfo($webentity, $body = null)
    {
        $returnType = '\Swagger\Client\Model\AcceptedResult';
        $request = $this->apiWebentityUserPutRequest($webentity, $body);
    ...
    /**
     * Operation apiWebentityUserPutAsync
     *
     * Update user data for current company and all related companies. Can be partially updated.
     *
     * @param  int $webentity (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityUserPutAsync($webentity, $body = null)
    {
        return $this->apiWebentityUserPutAsyncWithHttpInfo($webentity, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiWebentityUserPutAsyncWithHttpInfo
     *
     * Update user data for current company and all related companies. Can be partially updated.
     *
     * @param  int $webentity (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityUserPutAsyncWithHttpInfo($webentity, $body = null)
    {
        $returnType = '\Swagger\Client\Model\AcceptedResult';
        $request = $this->apiWebentityUserPutRequest($webentity, $body);
    ...
    /**
     * Create request for operation 'apiWebentityUserPut'
     *
     * @param  int $webentity (required)
     * @param  \Swagger\Client\Model\ChangeUserInfoViewModel $body User data with otp. (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiWebentityUserPutRequest($webentity, $body = null)
    {
        // verify the required parameter 'webentity' is set
        if ($webentity === null || (is_array($webentity) && count($webentity) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webentity when calling apiWebentityUserPut'
            );
        }
