...
class ValidationApi
{
    ...
    /**
     * Operation apiWebentityValidationEmailTokenGet
     *
     * Validates the a previously created token and returns customer data if any.
     *
     * @param  string $token Gets or sets the token. (required)
     ...
     */
    public function apiWebentityValidationEmailTokenGet($token, $webentity)
    {
        list($response) = $this->apiWebentityValidationEmailTokenGetWithHttpInfo($token, $webentity);
        return $response;
    }

    /**
     * Operation apiWebentityValidationEmailTokenGetWithHttpInfo
     *
     * Validates the a previously created token and returns customer data if any.
     *
     * @param  string $token Gets or sets the token. (required)
     ...
     */
    public function apiWebentityValidationEmailTokenGetWithHttpInfo($token, $webentity)
    {
        $returnType = '\Swagger\Client\Model\UserViewModel';
        $request = $this->apiWebentityValidationEmailTokenGetRequest($token, $webentity);
    ...
    /**
     * Operation apiWebentityValidationEmailTokenGetAsync
     *
     * Validates the a previously created token and returns customer data if any.
     *
     * @param  string $token Gets or sets the token. (required)
     ...
     */
    public function apiWebentityValidationEmailTokenGetAsync($token, $webentity)
    {
        return $this->apiWebentityValidationEmailTokenGetAsyncWithHttpInfo($token, $webentity)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiWebentityValidationEmailTokenGetAsyncWithHttpInfo
     *
     * Validates the a previously created token and returns customer data if any.
     *
     * @param  string $token Gets or sets the token. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityValidationEmailTokenGetAsyncWithHttpInfo($token, $webentity)
    {
        $returnType = '\Swagger\Client\Model\UserViewModel';
        $request = $this->apiWebentityValidationEmailTokenGetRequest($token, $webentity);
    ...
    /**
     * Create request for operation 'apiWebentityValidationEmailTokenGet'
     *
     * @param  string $token Gets or sets the token. (required)
     * @param  int $webentity (required)
     *
     ...
     */
    protected function apiWebentityValidationEmailTokenGetRequest($token, $webentity)
    {
        // verify the required parameter 'token' is set
        if ($token === null || (is_array($token) && count($token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $token when calling apiWebentityValidationEmailTokenGet'
            );
        }
        // verify the required parameter 'webentity' is set
        if ($webentity === null || (is_array($webentity) && count($webentity) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webentity when calling apiWebentityValidationEmailTokenGet'
            );
        }

        $resourcePath = '/api/{webentity}/validation/email/{token}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation apiWebentityValidationMobileTokenGet
     *
     * Validates the a previously created token and returns customer data if any.
     *
     * @param  string $token Gets or sets the token. (required)
     ...
     * @return \Swagger\Client\Model\UserViewModel
     */
    public function apiWebentityValidationMobileTokenGet($token, $webentity)
    {
        list($response) = $this->apiWebentityValidationMobileTokenGetWithHttpInfo($token, $webentity);
        return $response;
    }

    /**
     * Operation apiWebentityValidationMobileTokenGetWithHttpInfo
     *
     * Validates the a previously created token and returns customer data if any.
     *
     * @param  string $token Gets or sets the token. (required)
     ...
     * @return array of \Swagger\Client\Model\UserViewModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiWebentityValidationMobileTokenGetWithHttpInfo($token, $webentity)
    {
        $returnType = '\Swagger\Client\Model\UserViewModel';
        $request = $this->apiWebentityValidationMobileTokenGetRequest($token, $webentity);
    ...
    /**
     * Operation apiWebentityValidationMobileTokenGetAsync
     *
     * Validates the a previously created token and returns customer data if any.
     *
     * @param  string $token Gets or sets the token. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityValidationMobileTokenGetAsync($token, $webentity)
    {
        return $this->apiWebentityValidationMobileTokenGetAsyncWithHttpInfo($token, $webentity)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiWebentityValidationMobileTokenGetAsyncWithHttpInfo
     *
     * Validates the a previously created token and returns customer data if any.
     *
     * @param  string $token Gets or sets the token. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityValidationMobileTokenGetAsyncWithHttpInfo($token, $webentity)
    {
        $returnType = '\Swagger\Client\Model\UserViewModel';
        $request = $this->apiWebentityValidationMobileTokenGetRequest($token, $webentity);
    ...
    /**
     * Create request for operation 'apiWebentityValidationMobileTokenGet'
     *
     * @param  string $token Gets or sets the token. (required)
     * @param  int $webentity (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function apiWebentityValidationMobileTokenGetRequest($token, $webentity)
    {
        // verify the required parameter 'token' is set
        if ($token === null || (is_array($token) && count($token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $token when calling apiWebentityValidationMobileTokenGet'
            );
        }
        // verify the required parameter 'webentity' is set
        if ($webentity === null || (is_array($webentity) && count($webentity) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webentity when calling apiWebentityValidationMobileTokenGet'
            );
        }

        $resourcePath = '/api/{webentity}/validation/mobile/{token}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
