...
class GdprApi
{
     ...
     * @return \Swagger\Client\Model\StatusCodeResult
     */
    public function apiWebentityGdprGet($webentity)
    {
        list($response) = $this->apiWebentityGdprGetWithHttpInfo($webentity);
        return $response;
    }

    /**
     * Operation apiWebentityGdprGetWithHttpInfo
     *
     * Generate GDPR report. Create request to GDPR web service.
     *
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\StatusCodeResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function apiWebentityGdprGetWithHttpInfo($webentity)
    {
        $returnType = '\Swagger\Client\Model\StatusCodeResult';
        $request = $this->apiWebentityGdprGetRequest($webentity);
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\StatusCodeResult',
    ...
    /**
     * Operation apiWebentityGdprGetAsync
     *
     * Generate GDPR report. Create request to GDPR web service.
     *
     * @param  int $webentity (required)
     ...
     */
    public function apiWebentityGdprGetAsync($webentity)
    {
        return $this->apiWebentityGdprGetAsyncWithHttpInfo($webentity)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation apiWebentityGdprGetAsyncWithHttpInfo
     *
     * Generate GDPR report. Create request to GDPR web service.
     *
     * @param  int $webentity (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function apiWebentityGdprGetAsyncWithHttpInfo($webentity)
    {
        $returnType = '\Swagger\Client\Model\StatusCodeResult';
        $request = $this->apiWebentityGdprGetRequest($webentity);
    ...
    /**
     * Create request for operation 'apiWebentityGdprGet'
     *
     * @param  int $webentity (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function apiWebentityGdprGetRequest($webentity)
    {
        // verify the required parameter 'webentity' is set
        if ($webentity === null || (is_array($webentity) && count($webentity) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webentity when calling apiWebentityGdprGet'
            );
        }

        $resourcePath = '/api/{webentity}/gdpr';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
