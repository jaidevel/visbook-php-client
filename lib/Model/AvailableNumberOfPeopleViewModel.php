...
/**
 * AvailableNumberOfPeopleViewModel Class Doc Comment
 *
 * @category Class
 * @description Available number of people for price.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AvailableNumberOfPeopleViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AvailableNumberOfPeopleViewModel';
...
'exclude' => 'getExclude'    ];
     ...
     * Sets from
     *
     * @param int $from Gets from number.
     *
     * @return $this
     */
     ...
     * Sets exclude
     *
     * @param int[] $exclude Gets numbers of people that should be excluded from period [from,to].
     *
     * @return $this
     */
