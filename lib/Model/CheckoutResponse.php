 ...
 *
 * @category Class
 * @description Response from Checkout Api with status.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CheckoutResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'terminal_url' => 'string',
'checkout_status' => '\Swagger\Client\Model\CheckoutStatus',
'expired_reservations' => '\Swagger\Client\Model\ReservationCompanyRelation[]',
'giftcards_balance' => 'map[string,double]'    ];
...
'giftcards_balance' => 'giftcardsBalance'    ];
    ...
    protected static $setters = [
        'terminal_url' => 'setTerminalUrl',
'checkout_status' => 'setCheckoutStatus',
'expired_reservations' => 'setExpiredReservations',
'giftcards_balance' => 'setGiftcardsBalance'    ];
...
'expired_reservations' => 'getExpiredReservations',
'giftcards_balance' => 'getGiftcardsBalance'    ];
    ...
    {
        $this->container['terminal_url'] = isset($data['terminal_url']) ? $data['terminal_url'] : null;
        $this->container['checkout_status'] = isset($data['checkout_status']) ? $data['checkout_status'] : null;
        $this->container['expired_reservations'] = isset($data['expired_reservations']) ? $data['expired_reservations'] : null;
        $this->container['giftcards_balance'] = isset($data['giftcards_balance']) ? $data['giftcards_balance'] : null;
    }
    ...
    {
        return $this->container['terminal_url'];
    }

    /**
     * Sets terminal_url
     *
     * @param string $terminal_url Gets terminal url. User will be redirected to this url if payment successfully registered.
     *
     * @return $this
     */
    public function setTerminalUrl($terminal_url)
    {
        $this->container['terminal_url'] = $terminal_url;
     ...
     *
     * @return \Swagger\Client\Model\CheckoutStatus
     */
     ...
     *
     * @param \Swagger\Client\Model\CheckoutStatus $checkout_status checkout_status
     *
     * @return $this
     */
    ...
    /**
     * Gets expired_reservations
     *
     * @return \Swagger\Client\Model\ReservationCompanyRelation[]
     */
    public function getExpiredReservations()
    {
        return $this->container['expired_reservations'];
    }

    /**
     * Sets expired_reservations
     *
     * @param \Swagger\Client\Model\ReservationCompanyRelation[] $expired_reservations Gets or sets list with expired reservations.
     *
     * @return $this
     */
    public function setExpiredReservations($expired_reservations)
    {
        $this->container['expired_reservations'] = $expired_reservations;

        return $this;
    }

    /**
     * Gets giftcards_balance
     *
     * @return map[string,double]
     */
    public function getGiftcardsBalance()
    {
        return $this->container['giftcards_balance'];
    }

    /**
     * Sets giftcards_balance
     *
     * @param map[string,double] $giftcards_balance Gets or sets list of used giftcards balance.
     *
     * @return $this
     */
    public function setGiftcardsBalance($giftcards_balance)
    {
        $this->container['giftcards_balance'] = $giftcards_balance;
