...
/**
 * PriceAgeGroupResultViewModel Class Doc Comment
 *
 * @category Class
 * @description Age group price (PriceAdjustmentPercent).
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PriceAgeGroupResultViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PriceAgeGroupResultViewModel';
...
'age_from' => 'int',
'age_to' => 'int',
'price_adjustment_percent' => 'double'    ];
...
'age_from' => 'setAgeFrom',
'age_to' => 'setAgeTo',
'price_adjustment_percent' => 'setPriceAdjustmentPercent'    ];
...
'age_from' => 'getAgeFrom',
'age_to' => 'getAgeTo',
'price_adjustment_percent' => 'getPriceAdjustmentPercent'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['price_adjustment_percent'] = isset($data['price_adjustment_percent']) ? $data['price_adjustment_percent'] : null;
    }
     ...
     * Sets name
     *
     * @param string $name Gets or sets age group name.
     *
     * @return $this
     */
     ...
     * Sets age_from
     *
     * @param int $age_from Gets or sets age from.
     *
     * @return $this
     */
     ...
     * Sets age_to
     *
     * @param int $age_to Gets or sets age to.
     *
     * @return $this
     */
    ...
    /**
     * Gets price_adjustment_percent
     *
     * @return double
     */
    public function getPriceAdjustmentPercent()
    {
        return $this->container['price_adjustment_percent'];
    }

    /**
     * Sets price_adjustment_percent
     *
     * @param double $price_adjustment_percent Gets or sets price adjustment.
     *
     * @return $this
     */
    public function setPriceAdjustmentPercent($price_adjustment_percent)
    {
        $this->container['price_adjustment_percent'] = $price_adjustment_percent;
