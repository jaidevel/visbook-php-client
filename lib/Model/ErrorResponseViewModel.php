...
/**
 * ErrorResponseViewModel Class Doc Comment
 *
 * @category Class
 * @description Contains info about error with error code. Return this model for customer in PublishedException, BadRequest etc..
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ErrorResponseViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ErrorResponseViewModel';
    ...
    protected static $swaggerTypes = [
        'error' => 'string',
'error_code' => '\Swagger\Client\Model\PublishedExceptionErrorCode'    ];
...
'error_code' => 'getErrorCode'    ];
     ...
     * Sets error
     *
     * @param string $error Gets error message.
     *
     * @return $this
     */
     ...
     * Gets error_code
     *
     * @return \Swagger\Client\Model\PublishedExceptionErrorCode
     */
     ...
     * Sets error_code
     *
     * @param \Swagger\Client\Model\PublishedExceptionErrorCode $error_code error_code
     *
     * @return $this
     */
