...
/**
 * StepUnitsViewModel Class Doc Comment
 *
 * @category Class
 * @description Contains info about availability step and number of available units for this step.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StepUnitsViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StepUnitsViewModel';
...
'to' => 'getTo'    ];
     ...
     *
     * @param int $available_units Gets available units.
     *
     * @return $this
     */
     ...
     * Sets from
     *
     * @param string $from Gets from date.
     *
     * @return $this
     */
