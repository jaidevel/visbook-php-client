...
class MethodAttributes
{
     ...
     */
    const REUSE_SLOT = 'ReuseSlot';
const _PRIVATE = 'Private';
const FAM_AND_ASSEM = 'FamANDAssem';
const ASSEMBLY = 'Assembly';
const FAMILY = 'Family';
const FAM_OR_ASSEM = 'FamORAssem';
const _PUBLIC = 'Public';
const MEMBER_ACCESS_MASK = 'MemberAccessMask';
const UNMANAGED_EXPORT = 'UnmanagedExport';
const _STATIC = 'Static';
const _FINAL = 'Final';
const VIRTUAL = 'Virtual';
const HIDE_BY_SIG = 'HideBySig';
const NEW_SLOT = 'NewSlot';
const CHECK_ACCESS_ON_OVERRIDE = 'CheckAccessOnOverride';
const _ABSTRACT = 'Abstract';
const SPECIAL_NAME = 'SpecialName';
const RT_SPECIAL_NAME = 'RTSpecialName';
const PINVOKE_IMPL = 'PinvokeImpl';
const HAS_SECURITY = 'HasSecurity';
const REQUIRE_SEC_OBJECT = 'RequireSecObject';
...
self::FAM_OR_ASSEM,
self::_PUBLIC,
self::MEMBER_ACCESS_MASK,
self::UNMANAGED_EXPORT,
self::_STATIC,
self::_FINAL,
self::VIRTUAL,
self::HIDE_BY_SIG,
self::NEW_SLOT,
self::CHECK_ACCESS_ON_OVERRIDE,
self::_ABSTRACT,
self::SPECIAL_NAME,
self::RT_SPECIAL_NAME,
self::PINVOKE_IMPL,
self::HAS_SECURITY,
self::REQUIRE_SEC_OBJECT,
self::RESERVED_MASK,        ];
    }
}
