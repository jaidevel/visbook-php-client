...
/**
 * AnonymizationViewModel Class Doc Comment
 *
 * @category Class
 * @description Anonymization info.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AnonymizationViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AnonymizationViewModel';
...
'when' => 'when'    ];
    ...
    protected static $setters = [
        'can_be_anonymized' => 'setCanBeAnonymized',
'when' => 'setWhen'    ];
    ...
    protected static $getters = [
        'can_be_anonymized' => 'getCanBeAnonymized',
'when' => 'getWhen'    ];
    ...
    {
        $this->container['can_be_anonymized'] = isset($data['can_be_anonymized']) ? $data['can_be_anonymized'] : null;
    ...
    /**
     * Gets can_be_anonymized
     *
     * @return bool
     */
    public function getCanBeAnonymized()
    {
        return $this->container['can_be_anonymized'];
    }

    /**
     * Sets can_be_anonymized
     *
     * @param bool $can_be_anonymized Gets a value indicating whether user can be anonymized or not.
     *
     * @return $this
     */
    public function setCanBeAnonymized($can_be_anonymized)
    {
        $this->container['can_be_anonymized'] = $can_be_anonymized;
     ...
     * Sets when
     *
     * @param \DateTime $when Gets date when user can be anonymized.
     *
     * @return $this
     */
