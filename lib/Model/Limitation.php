 ...
 *
 * @category Class
 * @description Stores info about limitations for fields.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Limitation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Limitation';
...
'pattern' => 'getPattern'    ];
     ...
     * Sets max_length
     *
     * @param int $max_length Gets or sets max length.
     *
     * @return $this
     */
     ...
     * Sets pattern
     *
     * @param string $pattern Gets or sets pattern.
     *
     * @return $this
     */
