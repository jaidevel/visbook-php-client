...
class GenericParameterAttributes
{
     ...
     */
    const NONE = 'None';
const COVARIANT = 'Covariant';
const CONTRAVARIANT = 'Contravariant';
const VARIANCE_MASK = 'VarianceMask';
const REFERENCE_TYPE_CONSTRAINT = 'ReferenceTypeConstraint';
const NOT_NULLABLE_VALUE_TYPE_CONSTRAINT = 'NotNullableValueTypeConstraint';
const DEFAULT_CONSTRUCTOR_CONSTRAINT = 'DefaultConstructorConstraint';
const SPECIAL_CONSTRAINT_MASK = 'SpecialConstraintMask';
    /**
...
self::CONTRAVARIANT,
self::VARIANCE_MASK,
self::REFERENCE_TYPE_CONSTRAINT,
self::NOT_NULLABLE_VALUE_TYPE_CONSTRAINT,
self::DEFAULT_CONSTRUCTOR_CONSTRAINT,
self::SPECIAL_CONSTRAINT_MASK,        ];
    }
}
