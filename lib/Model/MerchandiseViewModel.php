...
/**
 * MerchandiseViewModel Class Doc Comment
 *
 * @category Class
 * @description Info about merchandises.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MerchandiseViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MerchandiseViewModel';
    ...
    protected static $swaggerTypes = [
        'id' => '\Swagger\Client\Model\MerchandiseId',
...
'price' => 'getPrice'    ];
     ...
     * Gets id
     *
     * @return \Swagger\Client\Model\MerchandiseId
     */
     ...
     * Sets id
     *
     * @param \Swagger\Client\Model\MerchandiseId $id id
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Gets or sets merchandise name (translated).
     *
     * @return $this
     */
     ...
     * Sets default_name
     *
     * @param string $default_name Gets or sets merchandise name (default, not translated).
     *
     * @return $this
     */
     ...
     * Sets price
     *
     * @param double $price Gets or sets merchandise price.
     *
     * @return $this
     */
