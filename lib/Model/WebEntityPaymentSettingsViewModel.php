...
/**
 * WebEntityPaymentSettingsViewModel Class Doc Comment
 *
 * @category Class
 * @description Contains info about web entity payment types settings.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WebEntityPaymentSettingsViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WebEntityPaymentSettingsViewModel';
    ...
    protected static $swaggerTypes = [
        'payment_types' => '\Swagger\Client\Model\WebEntityPaymentTypeViewModel[]',
'no_online_payment' => '\Swagger\Client\Model\PaymentTypeSettingsViewModel',
'net_axept' => '\Swagger\Client\Model\PaymentTypeSettingsViewModel',
'partial_payment' => '\Swagger\Client\Model\PaymentTypeSettingsViewModel',
'invoice' => '\Swagger\Client\Model\PaymentTypeSettingsViewModel'    ];
...
'no_online_payment' => 'setNoOnlinePayment',
'net_axept' => 'setNetAxept',
...
'no_online_payment' => 'getNoOnlinePayment',
'net_axept' => 'getNetAxept',
...
'invoice' => 'getInvoice'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['no_online_payment'] = isset($data['no_online_payment']) ? $data['no_online_payment'] : null;
        $this->container['net_axept'] = isset($data['net_axept']) ? $data['net_axept'] : null;
     ...
     * Sets payment_types
     *
     * @param \Swagger\Client\Model\WebEntityPaymentTypeViewModel[] $payment_types Gets or sets list of payment types.
     *
     * @return $this
     */
    ...
    /**
     * Gets no_online_payment
     *
     * @return \Swagger\Client\Model\PaymentTypeSettingsViewModel
     */
    public function getNoOnlinePayment()
    {
        return $this->container['no_online_payment'];
    }

    /**
     * Sets no_online_payment
     *
     * @param \Swagger\Client\Model\PaymentTypeSettingsViewModel $no_online_payment no_online_payment
     *
     * @return $this
     */
    public function setNoOnlinePayment($no_online_payment)
    {
        $this->container['no_online_payment'] = $no_online_payment;
    ...
    {
        return $this->container['net_axept'];
    }

    /**
     * Sets net_axept
     *
     * @param \Swagger\Client\Model\PaymentTypeSettingsViewModel $net_axept net_axept
     *
     * @return $this
     */
    public function setNetAxept($net_axept)
    {
        $this->container['net_axept'] = $net_axept;
     ...
     *
     * @param \Swagger\Client\Model\PaymentTypeSettingsViewModel $partial_payment partial_payment
     *
     * @return $this
     */
     ...
     * Sets invoice
     *
     * @param \Swagger\Client\Model\PaymentTypeSettingsViewModel $invoice invoice
     *
     * @return $this
     */
