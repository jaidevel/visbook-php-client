...
/**
 * WebEntityImageViewModel Class Doc Comment
 *
 * @category Class
 * @description Image for WebEntity.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WebEntityImageViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WebEntityImageViewModel';
    ...
    protected static $swaggerTypes = [
        'image_path' => 'string',
'transformer' => 'string',
'image_type' => '\Swagger\Client\Model\SettingTypeViewModel'    ];
...
'image_type' => 'getImageType'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['transformer'] = isset($data['transformer']) ? $data['transformer'] : null;
     ...
     * Sets image_path
     *
     * @param string $image_path Gets or sets image path.
     *
     * @return $this
     */
    ...
    {
        return $this->container['transformer'];
    }

    /**
     * Sets transformer
     *
     * @param string $transformer Gets or sets transformer of image path.
     *
     * @return $this
     */
    public function setTransformer($transformer)
    {
        $this->container['transformer'] = $transformer;
     ...
     * Gets image_type
     *
     * @return \Swagger\Client\Model\SettingTypeViewModel
     */
     ...
     * Sets image_type
     *
     * @param \Swagger\Client\Model\SettingTypeViewModel $image_type image_type
     *
     * @return $this
     */
