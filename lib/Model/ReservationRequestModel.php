...
/**
 * ReservationRequestModel Class Doc Comment
 *
 * @category Class
 * @description All info needed for creating reservation.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReservationRequestModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReservationRequestModel';
...
'web_product_id' => 'getWebProductId'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['web_product_id'] === null) {
            $invalidProperties[] = "'web_product_id' can't be null";
        }
     ...
     * Sets web_product_id
     *
     * @param int $web_product_id Gets or sets web product Id.
     *
     * @return $this
     */
