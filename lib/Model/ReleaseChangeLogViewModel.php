...
/**
 * ReleaseChangeLogViewModel Class Doc Comment
 *
 * @category Class
 * @description Contains info about release change log.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReleaseChangeLogViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReleaseChangeLogViewModel';
...
'change_logs' => '\Swagger\Client\Model\ChangeLog[]'    ];
...
'change_logs' => 'getChangeLogs'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['change_logs'] = isset($data['change_logs']) ? $data['change_logs'] : null;
    }
     ...
     *
     * @param string $current_version Gets or sets current release version.
     *
     * @return $this
     */
    ...
    {
        return $this->container['change_logs'];
    }

    /**
     * Sets change_logs
     *
     * @param \Swagger\Client\Model\ChangeLog[] $change_logs Gets or sets list with all changes.
     *
     * @return $this
     */
    public function setChangeLogs($change_logs)
    {
        $this->container['change_logs'] = $change_logs;
