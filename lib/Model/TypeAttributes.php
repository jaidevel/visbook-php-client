...
class TypeAttributes
{
     ...
     */
    const ANSI_CLASS = 'AnsiClass';
const _PUBLIC = 'Public';
const NESTED_PUBLIC = 'NestedPublic';
const NESTED_PRIVATE = 'NestedPrivate';
const NESTED_FAMILY = 'NestedFamily';
const NESTED_ASSEMBLY = 'NestedAssembly';
const NESTED_FAM_AND_ASSEM = 'NestedFamANDAssem';
const NESTED_FAM_OR_ASSEM = 'NestedFamORAssem';
const SEQUENTIAL_LAYOUT = 'SequentialLayout';
const EXPLICIT_LAYOUT = 'ExplicitLayout';
const LAYOUT_MASK = 'LayoutMask';
const _INTERFACE = 'Interface';
const _ABSTRACT = 'Abstract';
const SEALED = 'Sealed';
const SPECIAL_NAME = 'SpecialName';
const RT_SPECIAL_NAME = 'RTSpecialName';
const IMPORT = 'Import';
const SERIALIZABLE = 'Serializable';
const WINDOWS_RUNTIME = 'WindowsRuntime';
const UNICODE_CLASS = 'UnicodeClass';
const AUTO_CLASS = 'AutoClass';
const CUSTOM_FORMAT_CLASS = 'CustomFormatClass';
const HAS_SECURITY = 'HasSecurity';
const RESERVED_MASK = 'ReservedMask';
const BEFORE_FIELD_INIT = 'BeforeFieldInit';
const CUSTOM_FORMAT_MASK = 'CustomFormatMask';
    /**
...
self::NESTED_FAM_AND_ASSEM,
self::NESTED_FAM_OR_ASSEM,
self::SEQUENTIAL_LAYOUT,
...
self::SEALED,
self::SPECIAL_NAME,
self::RT_SPECIAL_NAME,
self::IMPORT,
self::SERIALIZABLE,
self::WINDOWS_RUNTIME,
self::UNICODE_CLASS,
self::AUTO_CLASS,
self::CUSTOM_FORMAT_CLASS,
self::HAS_SECURITY,
self::RESERVED_MASK,
self::BEFORE_FIELD_INIT,
self::CUSTOM_FORMAT_MASK,        ];
    }
}
