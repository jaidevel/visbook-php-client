...
class FieldAttributes
{
     ...
     */
    const PRIVATE_SCOPE = 'PrivateScope';
...
const FIELD_ACCESS_MASK = 'FieldAccessMask';
const _STATIC = 'Static';
const INIT_ONLY = 'InitOnly';
const LITERAL = 'Literal';
const NOT_SERIALIZED = 'NotSerialized';
const HAS_FIELD_RVA = 'HasFieldRVA';
const SPECIAL_NAME = 'SpecialName';
const RT_SPECIAL_NAME = 'RTSpecialName';
const HAS_FIELD_MARSHAL = 'HasFieldMarshal';
const PINVOKE_IMPL = 'PinvokeImpl';
const HAS_DEFAULT = 'HasDefault';
