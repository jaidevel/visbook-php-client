...
/**
 * PaymentTypeSettingsViewModel Class Doc Comment
 *
 * @category Class
 * @description Payment type settings.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PaymentTypeSettingsViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PaymentTypeSettingsViewModel';
    ...
    protected static $swaggerTypes = [
        'pay_now' => 'double',
'type' => '\Swagger\Client\Model\PaymentValueType',
'status' => '\Swagger\Client\Model\OrderStatusViewModel',
'paid' => '\Swagger\Client\Model\PaymentType',
'number_of_days' => 'int',
'never_due_after' => 'bool'    ];
...
'never_due_after' => 'setNeverDueAfter'    ];
...
'never_due_after' => 'getNeverDueAfter'    ];
    ...
    {
        $this->container['pay_now'] = isset($data['pay_now']) ? $data['pay_now'] : null;
        ...
        $this->container['never_due_after'] = isset($data['never_due_after']) ? $data['never_due_after'] : null;
    }
    ...
    {
        return $this->container['pay_now'];
    }

    /**
     * Sets pay_now
     *
     * @param double $pay_now Gets how much money should be paid now. Can be fixed money or percent of full order amount.
     *
     * @return $this
     */
    public function setPayNow($pay_now)
    {
        $this->container['pay_now'] = $pay_now;
     ...
     * Gets type
     *
     * @return \Swagger\Client\Model\PaymentValueType
     */
     ...
     * Sets type
     *
     * @param \Swagger\Client\Model\PaymentValueType $type type
     *
     * @return $this
     */
     ...
     * Sets paid
     *
     * @param \Swagger\Client\Model\PaymentType $paid paid
     *
     * @return $this
     */
     ...
     * Sets number_of_days
     *
     * @param int $number_of_days Gets number of days. Invoice due date for remaining sub total.
     *
     * @return $this
     */
    ...
    /**
     * Gets never_due_after
     *
     * @return bool
     */
    public function getNeverDueAfter()
    {
        return $this->container['never_due_after'];
    }

    /**
     * Sets never_due_after
     *
     * @param bool $never_due_after Gets a value indicating whether due before arrival or not. Never due date after day before arrival date.
     *
     * @return $this
     */
    public function setNeverDueAfter($never_due_after)
    {
        $this->container['never_due_after'] = $never_due_after;
