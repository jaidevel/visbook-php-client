...
/**
 * ProductGroupViewModel Class Doc Comment
 *
 * @category Class
 * @description Web product group info.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProductGroupViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProductGroupViewModel';
...
'name' => 'getName'    ];
     ...
     * Sets id
     *
     * @param int $id Gets or sets product group Id.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Gets or sets product group name.
     *
     * @return $this
     */
