...
/**
 * TermsViewModel Class Doc Comment
 *
 * @category Class
 * @description Contains terms data.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TermsViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TermsViewModel';
     ...
     * Sets terms
     *
     * @param string $terms Gets or sets terms text.
     *
     * @return $this
     */
