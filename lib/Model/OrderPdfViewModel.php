...
/**
 * OrderPdfViewModel Class Doc Comment
 *
 * @category Class
 * @description Contains info about pdf.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OrderPdfViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OrderPdfViewModel';
...
'type' => 'getType'    ];
     ...
     * Sets url
     *
     * @param string $url Gets or sets pdf url.
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type Gets or sets pdf type.
     *
     * @return $this
     */
