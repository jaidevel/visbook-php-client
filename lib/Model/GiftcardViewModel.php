...
/**
 * GiftcardViewModel Class Doc Comment
 *
 * @category Class
 * @description Contains info about gift card.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GiftcardViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GiftcardViewModel';
     ...
     * Sets balance
     *
     * @param double $balance Gets or sets gift card balance.
     *
     * @return $this
     */
