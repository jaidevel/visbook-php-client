...
/**
 * TimeZoneViewModel Class Doc Comment
 *
 * @category Class
 * @description Stores time zone information.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TimeZoneViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TimeZoneViewModel';
...
'iana' => 'getIana'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['iana'] = isset($data['iana']) ? $data['iana'] : null;
    }
     ...
     * Sets display_name
     *
     * @param string $display_name Gets or sets time zone display name.
     *
     * @return $this
     */
     ...
     * Sets offset
     *
     * @param string $offset Gets or sets time zone Offset.
     *
     * @return $this
     */
    ...
    {
        return $this->container['iana'];
    }

    /**
     * Sets iana
     *
     * @param string $iana Gets or sets time zone IANA.
     *
     * @return $this
     */
    public function setIana($iana)
    {
        $this->container['iana'] = $iana;
