...
/**
 * WebProductCalculatedPriceViewModel Class Doc Comment
 *
 * @category Class
 * @description Contains info avout calculated price and prices list.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WebProductCalculatedPriceViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WebProductCalculatedPriceViewModel';
...
'web_product_prices' => '\Swagger\Client\Model\CalendarWebProductPriceViewModel[]'    ];
...
'web_product_prices' => 'webProductPrices'    ];
...
'web_product_prices' => 'setWebProductPrices'    ];
...
'web_product_prices' => 'getWebProductPrices'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['web_product_prices'] = isset($data['web_product_prices']) ? $data['web_product_prices'] : null;
    }
     ...
     *
     * @param double $calculated_price Gets calculated price.
     *
     * @return $this
     */
    ...
    /**
     * Gets web_product_prices
     *
     * @return \Swagger\Client\Model\CalendarWebProductPriceViewModel[]
     */
    public function getWebProductPrices()
    {
        return $this->container['web_product_prices'];
    }

    /**
     * Sets web_product_prices
     *
     * @param \Swagger\Client\Model\CalendarWebProductPriceViewModel[] $web_product_prices Gets list of prices.
     *
     * @return $this
     */
    public function setWebProductPrices($web_product_prices)
    {
        $this->container['web_product_prices'] = $web_product_prices;
