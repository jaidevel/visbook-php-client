...
/**
 * BlockationReasonViewModel Class Doc Comment
 *
 * @category Class
 * @description View model for enum with serialization rules. Available only on web.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BlockationReasonViewModel
{
    /**
     * Possible values of this enum
     */
    const BLOCKATION_PERIOD = 'blockationPeriod';
const NO_PRICES_FOUND = 'noPricesFound';
const MAX_MIN_PEOPLE_ZERO = 'maxMinPeopleZero';
const NO_AVAILABLE_UNITS = 'noAvailableUnits';
const CLOSING_PERIOD_EXCEPTION = 'closingPeriodException';
const CLOSING_TIME_EXCEPTION = 'closingTimeException';
const BLOCKING_LENGTH_EXCEPTION = 'blockingLengthException';
const NO_STEPPING_DEFINED = 'noSteppingDefined';
const STAY_OVER = 'stayOver';
    /**
    ...
    {
        return [
            self::BLOCKATION_PERIOD,
self::NO_PRICES_FOUND,
self::MAX_MIN_PEOPLE_ZERO,
self::NO_AVAILABLE_UNITS,
self::CLOSING_PERIOD_EXCEPTION,
self::CLOSING_TIME_EXCEPTION,
self::BLOCKING_LENGTH_EXCEPTION,
self::NO_STEPPING_DEFINED,
self::STAY_OVER,        ];
    }
}
