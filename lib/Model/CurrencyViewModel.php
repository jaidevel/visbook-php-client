...
/**
 * CurrencyViewModel Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CurrencyViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CurrencyViewModel';
...
'name' => 'getName'    ];
     ...
     * Sets id
     *
     * @param int $id Gets or sets Currency Id.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Gets or sets currency name.
     *
     * @return $this
     */
