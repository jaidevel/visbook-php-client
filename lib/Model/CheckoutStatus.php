...
class CheckoutStatus
{
     ...
     */
    const OK = 'ok';
const SOME_RESERVATIONS_EXPIRED = 'someReservationsExpired';
const NO_PAYMENT = 'noPayment';
const INVOICE_PAYMENT = 'invoicePayment';
const PAYMENT_WITH_GIFTCARDS_ERROR = 'paymentWithGiftcardsError';
    /**
    ...
    public static function getAllowableEnumValues()
    {
        return [
            self::OK,
self::SOME_RESERVATIONS_EXPIRED,
self::NO_PAYMENT,
self::INVOICE_PAYMENT,
self::PAYMENT_WITH_GIFTCARDS_ERROR,        ];
    }
}
