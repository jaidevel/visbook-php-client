...
/**
 * UserViewModel Class Doc Comment
 *
 * @category Class
 * @description Contains info about User and anonimization.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserViewModel';
...
'anonymization' => '\Swagger\Client\Model\AnonymizationViewModel'    ];
...
'anonymization' => 'getAnonymization'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['anonymization'] = isset($data['anonymization']) ? $data['anonymization'] : null;
    }
     ...
     * Sets id
     *
     * @param int $id Gets or sets user Id.
     *
     * @return $this
     */
     ...
     *
     * @param string $encrypted_company_id Gets or sets user encrypted company Id.
     *
     * @return $this
     */
     ...
     */
    public function getAnonymization()
    {
        return $this->container['anonymization'];
    }

    /**
     * Sets anonymization
     *
     * @param \Swagger\Client\Model\AnonymizationViewModel $anonymization anonymization
     *
     * @return $this
     */
    public function setAnonymization($anonymization)
    {
        $this->container['anonymization'] = $anonymization;
