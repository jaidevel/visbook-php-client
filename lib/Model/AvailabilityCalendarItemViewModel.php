...
/**
 * AvailabilityCalendarItemViewModel Class Doc Comment
 *
 * @category Class
 * @description Model contains availability calendar item info.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AvailabilityCalendarItemViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AvailabilityCalendarItemViewModel';
    ...
    protected static $swaggerTypes = [
        'date' => '\DateTime',
'web_products' => '\Swagger\Client\Model\WebProductForCalendarViewModel[]'    ];
...
'web_products' => 'getWebProducts'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['web_products'] = isset($data['web_products']) ? $data['web_products'] : null;
    }
     ...
     * Sets date
     *
     * @param \DateTime $date Gets date info.
     *
     * @return $this
     */
     ...
     * Gets web_products
     *
     * @return \Swagger\Client\Model\WebProductForCalendarViewModel[]
     */
    public function getWebProducts()
    {
        return $this->container['web_products'];
    }

    /**
     * Sets web_products
     *
     * @param \Swagger\Client\Model\WebProductForCalendarViewModel[] $web_products Gets or sets web products list.
     *
     * @return $this
     */
    public function setWebProducts($web_products)
    {
        $this->container['web_products'] = $web_products;
