...
/**
 * AnalyticViewModel Class Doc Comment
 *
 * @category Class
 * @description Contains information about analytics.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AnalyticViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AnalyticViewModel';
...
'account_id' => 'getAccountId'    ];
     ...
     * Sets id
     *
     * @param int $id Gets or sets analytics Id.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name Gets or sets analytics name.
     *
     * @return $this
     */
     ...
     * Sets account_id
     *
     * @param string $account_id Gets or sets account Id.
     *
     * @return $this
     */
