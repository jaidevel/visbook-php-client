...
const NO_INLINING = 'NoInlining';
const FORWARD_REF = 'ForwardRef';
const SYNCHRONIZED = 'Synchronized';
const NO_OPTIMIZATION = 'NoOptimization';
const PRESERVE_SIG = 'PreserveSig';
const AGGRESSIVE_INLINING = 'AggressiveInlining';
const AGGRESSIVE_OPTIMIZATION = 'AggressiveOptimization';
const INTERNAL_CALL = 'InternalCall';
const MAX_METHOD_IMPL_VAL = 'MaxMethodImplVal';
    /**
