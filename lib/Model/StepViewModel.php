...
/**
 * StepViewModel Class Doc Comment
 *
 * @category Class
 * @description Contains info about availability step.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StepViewModel implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StepViewModel';
...
'to' => 'getTo'    ];
     ...
     * Sets from
     *
     * @param string $from Gets or sets from date.
     *
     * @return $this
     */
     ...
     * Sets to
     *
     * @param string $to Gets or sets to date.
     *
     * @return $this
     */
