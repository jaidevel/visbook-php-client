...
class OrdersApiTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test case for apiWebentityOrdersGet
     *
     * List the logged in guest's orders for current company..
     *
     */
    public function testApiWebentityOrdersGet()
    {
    }

    /**
     * Test case for apiWebentityOrdersIdGet
     *
     * Returns specific order data by identified id.              If encryptedCompanyId empty, current companyId will be used..
     *
     */
    public function testApiWebentityOrdersIdGet()
    {
    }
}
